...
class TextLoggerHook(LoggerHook):
    ...
    def _log_info(self, log_dict, trainer):
        ...
        if trainer.world_size > 1:
            if hasattr(trainer.model.module, 'bbox_head'):
                class_names = trainer.model.module.bbox_head.class_names
            elif hasattr(trainer.model.module.student, 'bbox_head'):
                class_names = trainer.model.module.student.bbox_head.class_names
            else:
                class_names = trainer.model.module.model.bbox_head.class_names
        else:
            if hasattr(trainer.model, 'bbox_head'):
                class_names = trainer.model.bbox_head.class_names
            elif hasattr(trainer.model.student, 'bbox_head'):
                class_names = trainer.model.student.bbox_head.class_names
            else:
                class_names = trainer.model.model.bbox_head.class_names
