import numpy as np
import spconv
if spconv.__version__ > '2.0.0':
    import spconv.pytorch as spconv
    from spconv.pytorch import SparseConv3d, SubMConv3d
else:
    from spconv import Sparseonv3d, SubConv3d
...
class SpMiddleResNetFHD(nn.Module):
    def __init__(
        self, num_input_features=128, norm_cfg=None, name="SpMiddleResNetFHD", student=False, **kwargs
    ):
